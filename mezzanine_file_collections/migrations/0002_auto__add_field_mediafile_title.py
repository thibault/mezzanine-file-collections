...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaFile.title'
        db.add_column(u'mezzanine_media_library_mediafile', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaFile.title'
        db.delete_column(u'mezzanine_media_library_mediafile', 'title')
